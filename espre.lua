local Drawing = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Vzltex/DRAWINGAPI/master/ESP.lua"))();
...
local espColor = fromRGB(0, 255, 149);
...
local function characterAdded(plr)
    ...
    tracking[#tracking + 1] = Drawing.new({
        plr = plr,
        espBoxVisible = true,
        tracerVisible = true,
        text = plr.Name,
