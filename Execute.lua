...
function Notify(titletxt, text, time)
    ...
    title.Text = titletxt
    title.TextColor3 = Color3.new(255, 99, 71)--color to liking
    title.TextSize = 25--size to liking
    
    message.BackgroundColor3 = Color3.new(30,30,30)
    message.BackgroundTransparency = 1
    message.Position = UDim2.new(0, 0, 0, 30)
    message.Size = UDim2.new(1, 0, 1, -30)
    message.Font = Enum.Font.SourceSans
    message.Text = text
    message.TextColor3 = Color3.new(255, 99, 71)--color to liking
    message.TextSize = 20.5--size to liking
...
Notify("Syntax Notification", "Executed Script!", 10)
